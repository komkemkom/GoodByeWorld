	   ...
	   <nav id="nav-wrap">
	   	...
	   	<div class="row">
	               ...
	               <li><a href="archives.php">Archives</a></li>
			      	<li class="has-children current"><a href="blog.php">Blog</a>
							<ul>
	   		...
	   		<article class="entry">
					...
					<header class="entry-header">
						...
						<h2 class="entry-title">
							<a href="single.php" title="">Hey, We Love Open Sans!</a>
						</h2>
				...
				<article class="entry">
					...
					<header class="entry-header">
						...
						<h2 class="entry-title">
							<a href="single.php" title="">We All Love Good Typography.</a>
						</h2>
				...
				<article class="entry">
					...
					<header class="entry-header">
						...
						<h2 class="entry-title">
							<a href="single.php" title="">White Space Everywhere.</a>
						</h2>
				...
				<article class="entry">
					...
					<header class="entry-header">
						...
						<h2 class="entry-title">
							<a href="single.php" title="">Simple And Minimalist Designs.</a>
						</h2>
